...
import com.divide.experience.lib.api.feign.auth.AuthorizationFeignClient;
...
public class AuthorisationController implements AuthorizationFeignClient {
    ...
    public UserAuthDetailsData getUserByToken(@ApiParam(value = "JWT token", example = "Bearer asdad1213xffvx2311311a",
        required = true)
